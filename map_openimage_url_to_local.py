...
# -*- coding: utf-8 -*-
"""
https://github.com/apple/pico-banana-400k/blob/main/map_openimage_url_to_local.py
...
is_multi_turn = True  # <-- Set to True for multi-turn format
metadata_csv = "openimages/train-images-boxable-with-rotation.csv"
jsonl_in = "multi-turn.jsonl"  # or preference.jsonl or multi-turn.jsonl;change to your actual file path
jsonl_out = "multi-turn-mapped.jsonl" # change to your actual desired file path
